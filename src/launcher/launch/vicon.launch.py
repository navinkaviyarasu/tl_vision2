...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('update_freq',default_value='100'),
        DeclareLaunchArgument('refresh_freq',default_value='1'),
        DeclareLaunchArgument('multi_sensor',default_value='false'),
        DeclareLaunchArgument('use_vrpn_timestamps',default_value='false'),
        DeclareLaunchArgument('mocap_use',default_value='1',description='Intended use of the mocap data: 1. EKF sensor fusion 2. Ground truth reference'),
